...
public class gridAdapter extends BaseAdapter{
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        {
            imageView.setImageResource(R.drawable.attendenc3);
        ...
        {
            imageView.setImageResource(R.drawable.sheduler3);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        {
            imageView.setImageResource(R.drawable.notes3);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        {
            imageView.setImageResource(R.drawable.calculator3);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        else if(names.get(position).toString().equals("Browser"))
        {
            imageView.setImageResource(R.drawable.browser3);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent launchinIntend = new Intent(activity, Browser.class);
                    activity.startActivity(launchinIntend);
                }
            });
        }
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext())
                ...
                .setSmallIcon(R.drawable.notes3)
