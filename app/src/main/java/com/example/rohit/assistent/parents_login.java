    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(parents_login.this, teacher_ragistration.class));
            }
        });
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Boolean chkmailpass = db.emailpassparents(email, pass);

                if (chkmailpass == true) {
                    Toast.makeText(getApplicationContext(), "Login Successfully", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(parents_login.this, parent_activity.class));

                } else {
                    Toast.makeText(getApplicationContext(), "Wrong EmailId and Password", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(parents_login.this, prents_singup.class));
                }
            }
        });
    }
