...
public class teacher_ragistration extends AppCompatActivity {
    DatabaseHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_ragistration);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(s1.equals("") || s2.equals("") || s3.equals("")){
                    ...
                    if(s2.equals(s3)){
                        Boolean chkmail = db.chkemailteacher(s1);
                        if(chkmail == true){
                            Boolean insert = db.insertteacher(s1,s2);
                            if(insert == true){
                                Toast.makeText(getApplicationContext(),"Register successfully",Toast.LENGTH_LONG).show();
                                startActivity(new Intent(teacher_ragistration.this, teacher_login.class ));
                            }
                        }
